...
| --- | --- | --- |
| ID-porten | [v3 (codex)](https://github.com/suphiro-arch/NA-kunnskap/blob/main/arkitektur/produkter/produktbeskrivelser/01-ID-porten-produkt-canvas-v3-codex.md) | kobler innloggingen til en entydig digital identitet som tjenesteeier kan bruke videre i sin saks- og tjenestelogikk |
| ELMA | [v3 (codex)](https://github.com/suphiro-arch/NA-kunnskap/blob/main/arkitektur/produkter/produktbeskrivelser/10-ELMA-produkt-canvas-v3-codex.md) | kobler virksomhet og deltakeradresse til entydige identifikatorer i Peppol-økosystemet |
