...
| Altinn Formidling | [v3 (codex)](https://github.com/suphiro-arch/NA-kunnskap/blob/main/arkitektur/produkter/produktbeskrivelser/08-Altinn-formidling-produkt-canvas-v3-codex.md) | Mottaker henter data fra formidlingstjeneste |
| Altinn Events | [v3 (codex)](https://github.com/suphiro-arch/NA-kunnskap/blob/main/arkitektur/produkter/produktbeskrivelser/12-Altinn-events-produkt-canvas-v3-codex.md) | – Abonnent mottar hendelser |
...
| Opptaksløsninger | [v1 (codex)](/NA-kunnskap/produkter/49-Opptakslosninger-produkt-canvas-v1-codex/) | Opptaksløsningene bruker data fra flere kilder som del av samordnet opptak. |
| microdata.no | [v1 (codex)](/NA-kunnskap/produkter/63-microdata-no-produkt-canvas-v1-codex/) | microdata.no bygger på bruk av data fra flere registre og kilder som stilles til rådighet i plattformen. |
