...
| --- | --- | --- | --- | --- |
| eFormidling | v2 (copilot) | Sikring av informasjonsflyt og datautveksling | Kryptering, integritet, ikke-benektelse | [Fil](https://github.com/suphiro-arch/NA-kunnskap/blob/main/results/Produktbeskrivelser/07-eFormidling-produkt-canvas-v2-copilot.md) |
| Altinn formidling (Broker) | v2 (copilot) | Informasjonssikkerhet | Kryptering, autentisering, tilgangskontroll | [Fil](https://github.com/suphiro-arch/NA-kunnskap/blob/main/results/Produktbeskrivelser/08-Altinn-formidling-produkt-canvas-v2-copilot.md) |
