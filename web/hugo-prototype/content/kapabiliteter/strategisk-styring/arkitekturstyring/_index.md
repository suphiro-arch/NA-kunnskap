...
productsMarkdown: |
  ...
  <div class="capability-product-links">
    <article class="capability-product-link resource-type--normative">
      ...
      <p class="capability-product-link__description">Katalogen gir et felles grunnlag som virksomheter kan styre arkitekturvalg og anskaffelser mot.</p>
    </article>
    ...
    <article class="capability-product-link resource-type--policy">
      ...
      <p class="capability-product-link__description">gjør samhandlingsevne til et forpliktende rammeverk med vurderingsplikt, styre og felles rammeverk, framfor et faglig råd uten konsekvens.</p>
    </article>
    <article class="capability-product-link resource-type--normative">
      <p class="capability-product-link__type">Normerende ressurs</p>
      ...
      <p class="capability-product-link__description">gir metoden og arbeidsflyten som gjør interoperabilitetsvurderingen til et reelt styringsgrep i regelverks- og løsningsarbeid, ikke bare et krav på papiret.</p>
    </article>
    <article class="capability-product-link resource-type--normative">
      <p class="capability-product-link__type">Normerende ressurs</p>
      ...
      <p class="capability-product-link__description">gjør etterlevelsen av vurderingsplikten synlig og etterprøvbar, og gir styret for Interoperable Europe et datagrunnlag for å følge opp hvordan samhandlingshensyn faktisk ivaretas.</p>
    </article>
    <article class="capability-product-link resource-type--normative">
      <p class="capability-product-link__type">Normerende ressurs</p>
