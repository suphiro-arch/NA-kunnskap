...
## Kanaler
- Altinn docs (produkt- og teknisk dokumentasjon).
- Utviklerportaler og API-dokumentasjon.
...
- https://docs.altinn.studio/nb/altinn-studio/v8/
- https://docs.altinn.studio/nb/altinn-studio/v8/getting-started/
- https://docs.altinn.studio/nb/altinn-studio/v8/reference/
