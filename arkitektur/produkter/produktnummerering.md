...
| 27 | `KS-003` | Fiks SvarUt | Fellesløsning | Utgående post | API-basert tjeneste | Datautveksling og integrasjon: Meldingsformidling<br>Samarbeid: Organisatorisk samhandling<br>Sluttbrukertjenester: Sammenhengende tjenester | v3 (codex) | [Åpne](../../arkitektur/produkter/produktbeskrivelser/27-SvarUt-produkt-canvas-v3-codex.md) |
