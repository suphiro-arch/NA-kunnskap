...
| 28 | `KS-004` | Fiks register | Fellesløsning | Registertilgang | Overordnet registerfamilie i Fiks | Datakilder: Grunndata<br>Datautveksling og integrasjon: Bruke data fra andre | v1 (codex) | [Åpne](../../arkitektur/produkter/produktbeskrivelser/28-FIKS-Register-produkt-canvas-v1-codex.md) |
...
| 68 | `KS-009` | Fiks skatte- og inntektsopplysninger | Fellesløsning | Tilgang til skatte- og inntektsopplysninger via Fiks | Undertjeneste under Fiks register; bør vurderes som egen ressurs på linje med Fiks folkeregister | Datakilder: Grunndata<br>Datautveksling og integrasjon: Bruke data fra andre | Ikke opprettet ennå | - |
| 69 | `KS-010` | Fiks kjøretøyregister | Fellesløsning | Tilgang til kjøretøyopplysninger via Fiks | Undertjeneste under Fiks register; bør vurderes som egen ressurs på linje med Fiks folkeregister | Datakilder: Grunndata<br>Datautveksling og integrasjon: Bruke data fra andre | Ikke opprettet ennå | - |
