...
| 4 | `DIGDIR-004` | Altinn Autorisasjon | Felleskomponent | Autorisasjonstjeneste for representasjon og tilgang | Sentral autorisasjonsbyggestein i Altinn | Tillit: Representasjon<br>Tillit: Tilgangskontroll<br>Tillit: Tilgangsstyring | v4 (codex) | [Åpne](../../arkitektur/produkter/produktbeskrivelser/04-Altinn-autorisasjon-produkt-canvas-v4-codex.md) |
...
| 26 | `KS-002` | Fiks melding | Fellesløsning | Meldingsutveksling | - | Datautveksling og integrasjon: Meldingsformidling<br>Informasjonssikkerhet: Sikring av informasjonsflyt og datautveksling<br>Samarbeid: Organisatorisk samhandling | v2 (codex) | [Åpne](../../arkitektur/produkter/produktbeskrivelser/26-FIKS-Melding-produkt-canvas-v2-codex.md) |
| 27 | `KS-003` | Fiks SvarUt | Fellesløsning | Utsendingstjeneste for digital og fysisk post | Sentralisert tjeneste med både API-baserte og portalbaserte grensesnitt | Datautveksling og integrasjon: Meldingsformidling<br>Samarbeid: Organisatorisk samhandling<br>Sluttbrukertjenester: Sammenhengende tjenester | v3 (codex) | [Åpne](../../arkitektur/produkter/produktbeskrivelser/27-FIKS-SvarUt-produkt-canvas-v3-codex.md) |
| 28 | `KS-004` | Fiks register | Fellesløsning | Registertilgang | Overordnet registerfamilie i Fiks | Datakilder: Grunndata<br>Datautveksling og integrasjon: Bruke data fra andre | v2 (codex) | [Åpne](../../arkitektur/produkter/produktbeskrivelser/28-FIKS-Register-produkt-canvas-v2-codex.md) |
...
| 57 | `KS-007` | SvarInn | Fellesløsning | Inngående post | API-basert tjeneste; komplement til Fiks SvarUt | Datautveksling og integrasjon: Meldingsformidling<br>Samarbeid: Organisatorisk samhandling | v1 (codex) | [Åpne](../../arkitektur/produkter/produktbeskrivelser/57-SvarInn-produkt-canvas-v1-codex.md) |
