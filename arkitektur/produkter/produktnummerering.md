...
| 57 | `KS-007` | SvarInn | Fellesløsning | Inngående post | API-basert tjeneste; komplement til SvarUt | Datautveksling og integrasjon: Meldingsformidling<br>Samarbeid: Organisatorisk samhandling | Ikke opprettet ennå | - |
| 67 | `KS-008` | FIKS Folkeregister | Fellesløsning | Tilgang til Folkeregisteret via FIKS | Viktig integrasjon i kommunal sektor | Datakilder: Grunndata<br>Datautveksling og integrasjon: Bruke data fra andre | Ikke opprettet ennå | - |
