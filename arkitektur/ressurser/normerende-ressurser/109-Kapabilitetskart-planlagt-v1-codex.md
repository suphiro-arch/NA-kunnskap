...
## Kapabiliteter
- **Arkitekturstyring**  
  Ressursen er tett knyttet til arkitekturstyring fordi den kan gjøre det lettere å strukturere prioriteringer, avhengigheter og styringsbehov i nasjonal arkitektur.

- **Datastyring**  
  Ressursen er også relevant for datastyring fordi kapabilitetskartet kan koble datadelingsbehov og informasjonsforvaltning til mer presise utviklings- og styringsbehov.

## Målgruppe og brukere
| Brukersegment | Primært behov | Bruksområde | Kommentar |
|---|---|---|---|
| Arkitekter og fagansvarlige | Felles modell for behov og gap | Analyse, målbilder og prioritering | Kjernebrukere |
| Portefølje- og ledelsesmiljø | Bedre begrunnelse for prioritering av tiltak | Veikart og samordning | Nyttig når tiltak konkurrerer om oppmerksomhet |
...
Ressursen er ikke tilstrekkelig alene når en skal velge konkrete løsninger, fastsette finansiering eller beslutte teknisk gjennomføring. Da må den suppleres med operative ressursbeskrivelser, styringsdata, juridiske vurderinger og konkret porteføljekontekst.

Den er heller ikke nok hvis problemet primært handler om lokalt organisasjonsdesign eller prosjektstyring. Da er kapabilitetskartet et støtteverktøy, ikke hovedsvaret.

## Scope og avgrensning
Inngår:
- struktur for å beskrive kapabiliteter, avhengigheter og utviklingsbehov
- kobling mellom mål, ressurser og gap i nasjonal arkitektur
- støtte til analyse, prioritering og samordning

Inngår ikke:
- ferdige valg av operative løsninger
- detaljert organisasjonsdesign eller prosjektplanlegging
...
Forretningsverdien ligger i at styring og prioritering kan bli mindre aktivitetsdrevet og mer behovsdrevet. Et kapabilitetskart kan gjøre det lettere å forklare hvorfor et tiltak er viktig, og om det faktisk løser et manglende behov eller bare bygger mer av det som allerede finnes.

Arkitekturverdien ligger i sterkere sporbarhet mellom mål, behov, ressurser og tiltak. Det gir et bedre grunnlag for å identifisere gap, redusere overlapp og begrunne samordning på tvers av porteføljer og sektorer.

## Konsekvens ved manglende bruk eller avvik
Hvis ressursen ikke brukes, er det større risiko for at analyse og prioritering skjer med ulike begreper og ulikt nivå på begrunnelsene. Da blir det vanskeligere å sammenligne tiltak, forstå reelle gap og bygge et felles språk for hva nasjonal arkitektur faktisk skal styrke.

Hvis ressursen brukes for sent, kan porteføljer og veikart allerede være etablert uten tydelig kobling mellom mål og underliggende evner. Det gjør senere samordning tyngre og mer reaktiv.
...
- **P2: Ta arkitekturbeslutninger på rett nivå**  
  Ressursen kan styrke beslutningskvaliteten ved å gjøre det tydeligere hvilke behov som hører hjemme i lokal løsning, felles ressurs eller nasjonal samordning.

- **P5: Del og gjenbruk løsninger**  
  Et tydelig kapabilitetskart kan synliggjøre hvor gjenbruk faktisk dekker behov, og hvor nye tiltak bare dupliserer eksisterende kapasitet.
...
- `arkitektur/kapabiliteter/capabilities.yaml`, kontrollert 2026-05-08
