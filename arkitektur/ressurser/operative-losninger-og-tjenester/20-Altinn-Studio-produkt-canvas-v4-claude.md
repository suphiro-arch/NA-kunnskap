...
- Altinn Studio er verifisert som digitalt fellesgode i registeret til Digital Public Goods Alliance, godkjent 25. desember 2022, knyttet til bærekraftsmål 16.
...
### Endringer i v4
- Analyseforbedringer: lagt inn at Altinn Studio er verifisert som digitalt fellesgode i DPG-registeret, godkjent 25. desember 2022, knyttet til bærekraftsmål 16.
- Presisert at det er `altinn-studio`-repositoriet som er vurdert i registreringen, slik at DPG-statusen ikke leses som at hele Altinn-plattformen er registrert.
- Dokumentert et lisensavvik: DPG-profilen oppgir BSD-3-Clause, mens repositoriet oppgir MIT ved kontroll 2026-09-09. Repositoriets angivelse er lagt til grunn, og avviket er beskrevet framfor å bli rettet i stillhet.
