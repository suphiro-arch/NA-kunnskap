...
- Når kommunen starter et nytt digitaliseringsprosjekt og må vite hvilke applikasjoner og datasett som alt finnes før noe anskaffes.
- Når kommunen skal vurdere konsekvenser av å endre eller fase ut et system, og trenger oversikt over avhengigheter.
- Når kommunen skal dokumentere arbeidet med Orden i eget hus og trenger et sted å samle oversikten.
- Når ledelsen må se om ROS, DPIA og databehandleravtaler faktisk er registrert for applikasjonene i bruk.
- Når kommunen vil avdekke at en fellestjeneste alt er i bruk et annet sted i organisasjonen, og unngå dobbeltarbeid.

### Når Fiks digiorden normalt ikke er førstevalg
- Når behovet er å dele data mellom systemer. Digiorden gir oversikt, men flytter ikke data.
- Når behovet er en autoritativ datakatalog med maskinlesbare beskrivelser for gjenbruk på tvers av forvaltningen. Da er `Felles datakatalog` (`DIGDIR-011`) rett flate.
- Når kommunen trenger selve sikkerhets- og personvernarbeidet utført. Digiorden viser om dokumentasjonen finnes, men er ikke en sikkerhetstjeneste.
- Når oversikten skal dekke annet enn kommunens eget digitale landskap.
...
- `Orden i eget hus` (`DIGDIR-036`) er metodikken Digiorden støtter i praksis.
- `Felles datakatalog` (`DIGDIR-011`) for nasjonal publisering av datasettbeskrivelser, der Digiorden dekker den interne oversikten.
- `Fiks-plattformen` (`KS-001`) for felles identitet, integrasjon og forvaltning.
- `Rammeverk for informasjonsforvaltning` (`DIGDIR-029`) som styrende faggrunnlag for arbeidet oversikten skal understøtte.
