...
- Når kommunen skal ilegge gebyr eller tilleggsavgift for parkering på kommunal veg og må slå opp eier av kjøretøyet.
- Når kommunen behandler søknad om parkeringstillatelse og trenger å bekrefte kjøretøyopplysninger.
- Når feilparkerte kjøretøy må håndteres i forbindelse med brøyting, feiing eller annet vegvedlikehold.
- Når oppslaget må gjøres for et bestemt tidspunkt, fordi eierforholdet på hendelsestidspunktet er det som har rettslig betydning.
- Når kommunen vil unngå å etablere og forvalte egen tilkobling mot Statens vegvesens grensesnitt.

### Når Fiks kjøretøyregister normalt ikke er førstevalg
- Når saksbehandleren trenger å gjøre oppslag manuelt i en portal. KS Digital oppgir at webportal ikke støttes i dag, og tjenesten forutsetter integrasjon i fagsystem.
- Når behovet gjelder andre registerdata enn kjøretøy. Da er `Fiks register` (`KS-004`) inngangen til de øvrige datakildene.
- Når virksomheten ikke er kommunal. Tilgangen forutsetter Fiks-avtale og tjenestevedlegg for kommunal sektor.
- Når behovet krever funksjoner eller data som bare finnes i Statens vegvesens egne grensesnitt. Fiks speiler sentrale oppslag, ikke hele kildens funksjonssett.
