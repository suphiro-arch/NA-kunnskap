...
Avgrensningen mot tilgangskontroll er uttrykkelig i dokumentasjonen. HelseID avgjør ikke spørsmål om tilgang til helseopplysninger eller tjenester, og avgjør heller ikke om det foreligger tjenstlig behov. Det er tjenestetilbyderne som setter krav til og utfører tilgangskontrollen, og helsevirksomheten selv som har ansvaret for at tjenstlig behov foreligger. HelseID leverer det verifiserte identitets- og tillitsgrunnlaget de bygger avgjørelsen på.
...
**Kildekode:** Ikke offentlig dokumentert. Selve tjenesten er ikke publisert, men Norsk helsenett publiserer klientbibliotek og eksempelkode på [github.com/NorskHelsenett](https://github.com/NorskHelsenett), blant annet `HelseID.Library.Java`.

**Lisens:** Ikke offentlig dokumentert for selve tjenesten. Klientbibliotekene `HelseID.Library.Java` og `HelseID.Library` har MIT, kontrollert mot repositoriene 2026-09-25.
...
### Analyseforbedringer
- `Tillit: Tilgangskontroll` er fjernet. NHNs egen dokumentasjon avviser koblingen direkte: «HelseID avgjør ikke spørsmål om tilgang til helseopplysninger eller tjenester, og avgjør heller ikke spørsmål om tjenstlig behov for tilgang til helseopplysninger.» Og videre: «Det er tjenestetilbydere, for eksempel nasjonale e-helsetjenester, som setter krav til og utfører tilgangskontroll for tilgang til helseopplysninger.» Forklaringen i `v1` sa selv at produktet «gir grunnlag for at tjenestetilbydere kan etablere regler», altså at andre håndhever.
- `Tillit: Autentisering` står. Den er kjernefunksjonen, og HelseID beriker i tillegg identitetsinformasjonen med opplysninger fra Helsepersonellregisteret og Personregisteret.
- Avgrensningen er skrevet inn i `Kort beskrivelse`, slik at forholdet mellom tillitsgrunnlag og tilgangsbeslutning går fram av teksten og ikke bare av kapabilitetslista.

### Tekstlige forbedringer
- Ingen øvrige endringer. Teksten fra `v1` er beholdt, siden revisjonen gjelder kapabilitetskoblingen og avgrensningen mot den.
