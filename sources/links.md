...
### [Nasjonale fellesløsninger](https://www.digdir.no/felleslosninger/nasjonale-felleslosninger/750, https://docs.altinn.studio/nb/)  
Oversikt over 26 nasjonale fellesløsninger som Altinn, ID-porten, Digital postkasse, eFormidling, eInnsyn m.fl. – byggeklosser for digital tjenesteutvikling i offentlig sektor. Bruk docs.altinn.no for alle tjenester tilknyttet Altinn.
...
### [Fiks-plattformen](https://ksdigital.no/tjenestene/fiks-plattformen/, https://ksdigital.no/tjenester-2/)  
Kommunesektorens felles tjenesteplattform for digital samhandling og integrasjoner med statlige felleskomponenter som ID-porten og Kontaktregisteret.

### [Fiks-plattformen – teknisk dokumentasjon (PDF)](https://developers.fiks.ks.no/fiks-plattformen.pdf)  
Detaljert informasjon om arkitektur, hovedkomponenter, tjenester og driftsmodell.
...
Rammeverk for innføring, utbredelse og gevinstrealisering av fellestjenester i kommunal sektor.

### [KS Digital – Felles Tjenesteplattform](https://www.digdir.no/digitaliseringsradet/ks-digital-tiltaket-felles-tjenesteplattform/7556)  
Beskrivelse av KS Digitals arbeid med en plattform for utvikling av kommunale digitale tjenester.
...
Veiledning om rapporteringsplikt for digitale plattformer etter OECD‑standarden.

### [DSOP – felleskomponenter og integrasjoner](https://dokumentasjon.dsop.no/)  
Felleskomponenter og API‑er som Maskinporten, samtykkeløsningen og Altinn-integrasjoner.

### [KS–Skatteetaten segmentsamarbeid](https://ksdigital.no/tjenestene/fiks-register/segmentsamarbeid/)  
Modell for tilgang til Skatteetatens data for kommunal sektor via KS Digital.
...
Nasjonal portal for innsyn og tilgang til helsedata fra helseregistre, kvalitetsregistre, helseundersøkelser og biobanker.

### [FHI – Avdeling Helsedata](https://www.fhi.no/om/organisasjon/helsedata/)  
Nasjonal tilgangsforvalter (Helsedataservice) med metadatakatalog og felles søknadssystem.

### [Helsedirektoratet – helseregistre og helsedata](https://www.helsedirektoratet.no/helseregistre-og-helsedata)  
Oversikt over sentrale registre som KUHR, HPR, FLO og rehabiliteringsregister.
...
Overordnet informasjon om helsedata, bruksområder og nasjonale datakilder.
...
Beskrivelse av geodatafellesløsninger og behov for modernisering av geodata-infrastruktur.

### [Kartverkets fellesløsninger](https://www.kartverket.no/geodataarbeid/felleslosningene)  
Oversikt over NGIS, høydedata, Norge i bilder, luftfartshindre m.m.
