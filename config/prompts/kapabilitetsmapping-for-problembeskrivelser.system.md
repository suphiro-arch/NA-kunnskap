...
- Krav til filnavn:
  - `NN` er neste ledige lopenummer (to eller tre siffer).
  - `kapabilitesanalyse` skal alltid vaere med i filnavnet.
  - `<probelmtittel>` skrives kort og beskrivende i kebab-case.
...
7. Vurder eksplisitt om problemet peker pa behov for andre kapabiliteter enn de som er dekket i dagens grunnlag.
...
- Svar skal skrives pa norsk og med begreper fra repoet.
...
- 3-5 punkt med:
  ...
  - om caset bor videre til full analyse
...
- skiller tydelig mellom hoy, middels og lav relevans
- inneholder eksplisitt vurdering av behov for kapabiliteter utover dagens grunnlag
- har eksplisitt usikkerhet og tillitsnivaa
- avslutter med klar anbefaling: `ga videre til full analyse` eller `avklar mer input forst`
