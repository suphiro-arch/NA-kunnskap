...
`Virkemiddelmekanisme` og `Forvaltningsmodell`, der kildene ofte er ufullstendige. Usikkerhet er ikke en grunn til å
...
## Kort beskrivelse
Kort og selvstendig beskrivelse av hva ressursen er, hvordan den virker, og hvilken rolle den har i sitt eget domene.
