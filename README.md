...
- `docs/`: øvrige statiske dokumenter og enkle landingssider som ikke er del av Hugo-deployen
...
- `docs/prototype/` er ikke lenger sannhetskilde eller publiseringsmål for prototypen.
