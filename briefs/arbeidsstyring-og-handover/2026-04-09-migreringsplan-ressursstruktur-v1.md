...
- `arkitektur/produkter/produktnummerering.md` fortsatt er operativ master for registerføring
...
- flere repo-deler peker fortsatt til `arkitektur/produkter/produktbeskrivelser/`.
...
Oppgaver:
- føre nye ressurser i `arkitektur/produkter/produktnummerering.md`
...
Oppgaver:
- kartlegge alle eksplisitte referanser til `arkitektur/produkter/produktbeskrivelser/`
...
Oppgaver:
- flytte Digdir-beskrivelser fra `arkitektur/produkter/produktbeskrivelser/` til `arkitektur/ressurser/operative-losninger-og-tjenester/`
...
- vurdere om `arkitektur/produkter/produktbeskrivelser/` skal avvikles eller stå igjen som historisk spor
