...
|---:|---|---|---|---|
| 31 | `HDIR-001` | Helsedata.no | `arkitektur/produkter/produktbeskrivelser/31-Helsedata-no-produkt-canvas-v1-codex.md` | `arkitektur/ressurser/operative-losninger-og-tjenester/31-Helsedata-no-produkt-canvas-v1-codex.md` |
| 32 | `NHN-001` | Helsenorge | `arkitektur/produkter/produktbeskrivelser/32-Helsenorge-produkt-canvas-v1-codex.md` | `arkitektur/ressurser/operative-losninger-og-tjenester/32-Helsenorge-produkt-canvas-v1-codex.md` |
| 33 | `NHN-002` | HelseID | `arkitektur/produkter/produktbeskrivelser/33-HelseID-produkt-canvas-v1-codex.md` | `arkitektur/ressurser/operative-losninger-og-tjenester/33-HelseID-produkt-canvas-v1-codex.md` |
| 34 | `NHN-003` | Kjernejournal | `arkitektur/produkter/produktbeskrivelser/34-Kjernejournal-produkt-canvas-v1-codex.md` | `arkitektur/ressurser/operative-losninger-og-tjenester/34-Kjernejournal-produkt-canvas-v1-codex.md` |
| 35 | `NHN-004` | e-resept | `arkitektur/produkter/produktbeskrivelser/35-e-resept-produkt-canvas-v1-codex.md` | `arkitektur/ressurser/operative-losninger-og-tjenester/35-e-resept-produkt-canvas-v1-codex.md` |
| 64 | `HDIR-002` | HPR | `arkitektur/produkter/produktbeskrivelser/64-HPR-produkt-canvas-v1-codex.md` | `arkitektur/ressurser/operative-losninger-og-tjenester/64-HPR-produkt-canvas-v1-codex.md` |
| 65 | `HELFO-001` | KUHR | `arkitektur/produkter/produktbeskrivelser/65-KUHR-produkt-canvas-v1-codex.md` | `arkitektur/ressurser/operative-losninger-og-tjenester/65-KUHR-produkt-canvas-v1-codex.md` |
...
Gjennomført:
- 7 siste helsefiler er flyttet fra `arkitektur/produkter/produktbeskrivelser/` til `arkitektur/ressurser/operative-losninger-og-tjenester/`
