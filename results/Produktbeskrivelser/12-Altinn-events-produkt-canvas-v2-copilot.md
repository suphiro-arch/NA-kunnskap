...
- **Informasjonssikkerheit: Sikring av informasjonsflyt** – Sikret transport; tilgangskontroll på abonnement
...
| **Sikkerheit** | Feil tilgang til hendelsesstrømmer = lekkasje av sensitiv kontekst | Middels | Fine-grained autorisasjon; kryptering; logging av tilgang |
| **Sikkerheit** | Massiv hendelsesmengde brukt til DoS-angrep | Låg (autentisering) | Rate-limiting; abuse-detection; monitoring |
...
- **Sikkerheit:** TLS-kryptering; authentication via Altinn autorisasjon
