...
- **Informasjonssikkerheit: Sikring av informasjonsflyt** – Sikker adresseoppslag med tilgangskontroll
...
| **Sikkerheit** | Uautorisert tilgang til oppslags-API = eksponering av virksomhetsdata | Låg (autentisering) | API-sikkerheit; rate-limiting; logging |
| **Sikkerheit** | Angripere misbruker API til masseoppslag | Middels | Rate-limiting; abuse-detection; monitoring |
