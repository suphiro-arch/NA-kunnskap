...
- **Informasjonssikkerheit: Sikring av informasjonsflyt** – Bygg-inn sikkerheit, autentisering, autorisasjon
...
- **Kvalitet:** Standardiserte mønstre sikrer konsisten kvalitet across tjenester
...
| **Sikkerheit** | Svak implementering av sikkerhetsmekanismer | Høy | Sikkerheits-guide; code review; best-practice templates |
...
- **P7 Sorger for tillit til oppgaveløsningen** – Sikkerheit og best-practice bygg-inn
